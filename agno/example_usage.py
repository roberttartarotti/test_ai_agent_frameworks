"""
Example usage of the Agno test library.

This script demonstrates how to use the Agno agents for weather and climate information.
"""
...
def run_examples():
    """Run example demonstrations of the Agno agents.
    ...
    print("Agno Test Library Example")
    print("=" * 40)
    print()
