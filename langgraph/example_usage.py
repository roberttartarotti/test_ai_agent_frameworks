"""
Example usage of the LangGraph test library.

This script demonstrates how to use the LangGraph agents for weather and climate information.
"""
...
def run_examples():
    """Run example demonstrations of the LangGraph agents.
    ...
    print("LangGraph Test Library Example")
    print("=" * 40)
    print()
